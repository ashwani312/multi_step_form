...
let currentStep = 1;
let currentCircle = 0;
const subscriptionPlan = document.querySelectorAll(".plan-card");
const multiPageSwitcher = document.querySelector(".switch");
const addons = document.querySelectorAll(".box");
const total = document.querySelector(".total b");
const planPrice = document.querySelector(".plan-price");
const multiPageSteps = document.querySelectorAll(".stp");
...
multiPageSwitcher.addEventListener("click", () => {
  const val = multiPageSwitcher.querySelector("input").checked;
  if (val) {
